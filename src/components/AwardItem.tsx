...
const AwardItem: React.FC<AwardItemProps> = ({ 
  ...
  return (
    <div 
      className={cn(
        "group p-6 rounded-lg border border-gray-100 bg-white transition-all duration-300",
    ...
    >
      <div className="flex items-start justify-between gap-4">
        <div className="flex-1">
          <h3 className="text-lg font-medium mb-1 group-hover:text-gray-900 transition-colors">
            {title}
          </h3>
        ...
        <div className="shrink-0 w-12 h-12 rounded-full bg-gray-100 flex items-center justify-center group-hover:bg-gray-200 transition-colors">
