...
export const researchProjects = [
  {
    ...
    description: "Investigating the behavior of quantum fields in the presence of strong gravitational fields, with a focus on Hawking radiation and the information paradox.",
    image: "https://images.unsplash.com/photo-1635070041078-e363dbe005cb?ixlib=rb-4.0.3&auto=format&fit=crop&w=800&q=80",
    tags: ["Quantum Gravity", "Black Holes", "Theoretical Physics"]
  },
  {
    id: 2,
    title: "Topological Phases in Condensed Matter Systems",
    description: "Exploring exotic quantum states of matter characterized by topological properties, with applications in quantum computing and spintronics.",
    image: "https://images.unsplash.com/photo-1581093577421-e484c235b499?ixlib=rb-4.0.3&auto=format&fit=crop&w=800&q=80",
    tags: ["Condensed Matter", "Topology", "Quantum Materials"]
  },
  {
    id: 3,
    title: "Quantum Computing Algorithms",
    description: "Developing novel quantum algorithms for simulating physical systems, with particular emphasis on quantum chemistry and materials science applications.",
...
export const experiences = [
  {
    id: 1,
    title: "PhD Candidate in Theoretical Physics",
    organization: "Example University",
    location: "Cambridge, MA",
    startDate: "Sep 2021",
    description: "Conducting research on quantum field theory in curved spacetime, with a focus on black hole information paradox. Teaching assistant for undergraduate quantum mechanics and mathematical methods in physics."
  },
  {
    id: 2,
    ...
    startDate: "Jun 2020",
    endDate: "Aug 2020",
    description: "Collaborated on a project developing theoretical frameworks for fault-tolerant quantum computation. Implemented numerical simulations of topological quantum codes."
  },
  {
    id: 3,
    title: "Master's Student in Physics",
    organization: "Sample Institute of Technology",
    location: "Zurich, Switzerland",
    startDate: "Sep 2019",
    endDate: "May 2021",
    description: "Completed coursework in advanced quantum mechanics, statistical physics, and condensed matter theory. Master's thesis on 'Topological Phases in Non-Hermitian Systems'."
  }
];
...
export const awards = [
  {
    ...
    year: 2023,
    description: "Recognized for exceptional contributions to theoretical physics research."
  },
  {
    id: 2,
    title: "International Conference on Quantum Information Travel Grant",
    organization: "International Quantum Science Foundation",
    year: 2022
  },
  {
    id: 3,
    ...
    year: 2022,
    description: "Awarded for exceptional performance as a teaching assistant in undergraduate physics courses."
  },
  {
    id: 4,
    ...
    year: 2021,
    description: "Competitive three-year fellowship supporting graduate studies and research."
  }
];

export const conferencesAndSchools = [
  {
    id: 1,
    title: "International Conference on Quantum Field Theory",
  ...
  {
    id: 2,
    title: "Summer School on Topological Quantum Matter",
  ...
  {
    id: 3,
    title: "Workshop on Quantum Information and Black Holes",
  ...
  {
    id: 4,
    title: "Advanced School on Computational Methods in Physics",
    organization: "Max Planck Institute for the Physics of Complex Systems",
...
export const skills = [
  {
    ...
    items: ["Quantum Field Theory", "General Relativity", "Condensed Matter Theory", "Statistical Mechanics"]
  },
  {
    category: "Computational Skills",
    items: ["Python", "MATLAB", "C++", "Julia", "Quantum Computing Frameworks"]
  },
  {
    category: "Mathematical Methods",
    items: ["Differential Geometry", "Group Theory", "Functional Analysis", "Numerical Methods"]
  },
  {
    category: "Languages",
    items: ["English (Native)", "German (Proficient)", "French (Intermediate)"]
  }
];
